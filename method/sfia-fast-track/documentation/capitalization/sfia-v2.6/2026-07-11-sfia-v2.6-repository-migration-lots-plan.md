...
**Source CSV :** SHA-256 `2a72757c6af186f2cb8aba5d488613be974cb12eed2d33b2d391edba5989f066` (correction routage F-005 2026-07-13 ; antérieur `551c2476…`)
...
| **E1 exécution** | **closed — merged via PR #181** (`f279d85217129b515f1d3caf6c8ce6492a75e123`) |
| **E1 manifeste** | **31/31** |
...
| **E2 statut** | **closed — validated via PR #182** (`82e123d2d5f323b96943b1e1705f41b73c89b95c`) |
...
| **E2 ambiguïtés** | **0** |
| **Statut exécution Lot E** | **closed — E1 + E2 integrated — 75/75** |
| **Rapport clôture Lot E** | `2026-07-12-sfia-v2.6-lot-e-closure.md` |
| **Next gate** | **Lots F–J routing decision — separate Morris GO required** |
...
| **Classifications finales** | superseded-validate-delete **4** (F-001–F-004) ; F-005 **conservé** (`validated` / `keep` / *(vide)*) |
...
| **Routage CSV post-correction** | **4/4** superseded → **lot-J** (`delete-candidate`) ; F-005 → *(vide)* (`keep`, hors Lots G/I/J) |
...
## 12.1 Repository Rationalization v2.6 — trajectoire F → H → J
...
2. **Lot F** = phase process — **closed** ; 4 superseded → lot-J ; F-005 conservé *(vide)* — hors Lots G/I/J
...
**CSV SHA :** `2a72757c6af186f2cb8aba5d488613be974cb12eed2d33b2d391edba5989f066` (correction routage F-005 2026-07-13)
