...
| **Keep confirmed** | **27** |
| **Archive approved** | **76** |
| **Archive execution started** | **yes** — sous-lot M0-DEC-008 |
| **Sous-lot M0-DEC-008** | **executed** on branch `archive/sfia-v2.6-lot-0-inventories` — **pending merge** |
| **Volume exécuté (cette PR)** | **9** inventaires temporaires |
...
| **Migration exécutée (autres)** | **non** |
| **Next gate** | PR readiness → décision Morris merge sous-lot M0-DEC-008 |
| **Lot A** | **not started** |
...
*Plan candidate — **Lot 0 closed** — **M0-DEC-008 executed (9)** on branch — **67 archives remaining** — **Lot A not started**.*
