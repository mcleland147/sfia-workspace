...
**Machine-readable :** `2026-07-11-sfia-v2.6-repository-cartography.csv` (SHA-256: `2000dc36a3410ec37a803d0baeb53846eda67b38cd1d45bfbc805bda8a0ab51a`)
...
| Direct Usage Evidence Final Review | *(commit substantif — review pack / handoff)* |
...
*Cartographie candidate — **CARTOGRAPHY CONTRACT FROZEN** — **USAGE DIMENSION FROZEN** — Pass Authority pending.*
