...
*Cartographie candidate — **CARTOGRAPHY CONTRACT FROZEN** — **USAGE / AUTHORITY / LIFECYCLE FROZEN** — PR Readiness **completed** — **MERGE PENDING MORRIS DECISION** — SFIA v2.4 **baseline** — SFIA v2.6 **candidate**.*
