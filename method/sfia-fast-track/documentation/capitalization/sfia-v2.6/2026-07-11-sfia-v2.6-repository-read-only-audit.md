...
- **Index concurrents :** principes repo v2.6 vs cadrage v2.6 (rôles différents, sujet proche)  
...
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-standard-principles.md` | Principes structure repo v2.6 (remplace arborescence cible antérieure) |
| `sfia-workspace-migration-plan.md` | Plan migration **antérieur** |
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-cleanup-framing.md` | Cadrage cleanup v2.6 (remplace cluster round 2) |
...
| Plans cleanup / migration | `sfia-workspace-migration-plan.md`, `2026-07-11-sfia-v2.6-repository-cleanup-framing.md`, `2026-07-11-sfia-v2.6-repository-standard-principles.md`… | Documents antérieurs réconciliés en cadrage/principes v2.6 | élevé |
...
| Plans migration concurrents | Docs antérieurs structure/migration réconciliés en v2.6 | faible | workspace-audit/, sfia-v2.6/ | oui |
...
|----------|---------------|------------|--------------------|---------------------------------|-------------------|
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-standard-principles.md` | Principes structure repo v2.6 (remplace arborescence cible antérieure) | Actif — v2.6 | Remplace input antérieur | Standard validé candidate | — |
...
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-cleanup-framing.md` | Cadrage cleanup v2.6 | Actif — remplace cluster round 2 | Évite doublon plan | Réconcilié avec migration-plan | — |
...
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-standard-principles.md` | SFIA v2.6 Repository Standard Principles | capitalisation / trajectoire | candidate | Audit, Candidate, audit, candidate | élevé |
...
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-standard-principles.md` | SFIA v2.6 Repository Standard Principles (remplace consolidation plan v1.1) | capitalisation / trajectoire | candidate | Audit, Notion, REX, audit | élevé |
...
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-cartography.md` | SFIA v2.6 Repository Cartography (remplace documentation audit) | incertain | absent | Audit, Notion, REX, archive, audit | élevé |
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-standard-principles.md` | SFIA v2.6 Repository Standard Principles (remplace structure target) | incertain | absent | Notion, REX, archive, audit, notion | élevé |
...
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-cartography.md` | Interv360 — historique intégré en cartographie v2.6 | audit antérieur | absent | Audit, Notion, archive, audit, rex | élevé |
...
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-cleanup-framing.md` | SFIA v2.6 Cleanup Framing (remplace cluster round 2) | audit antérieur | absent | Archive, Audit, Notion, REX, archive | élevé |
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-cartography.md` | SFIA v2.6 Repository Cartography (remplace global audit) | audit antérieur | absent | Audit, Notion, archive, audit, mcp | élevé |
...
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-standard-principles.md` | Principes structure repo v2.6 |
| sfia-workspace-migration-plan.md | Input historique |
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-cleanup-framing.md` | Cadrage cleanup v2.6 |
