...
|-----------------|----------------|-----------------|
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-standard-principles.md` | Principes structure repo v2.6 | Input audit — remplace arborescence cible antérieure |
...
| `method/sfia-fast-track/documentation/capitalization/sfia-v2.6/2026-07-11-sfia-v2.6-repository-cleanup-framing.md` | Cadrage cleanup v2.6 | Remplace cluster cleanup round 2 — éviter doublon de plan |
...
| **4 — Arborescence cible** | Proposition v2.6 ; delta vs `2026-07-11-sfia-v2.6-repository-standard-principles.md` ; plan de réconciliation |
