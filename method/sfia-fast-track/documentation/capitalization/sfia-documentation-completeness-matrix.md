...
| Documentation | Plan documentaire et Notion | `method/sfia-fast-track/documentation/` | **OK** | Mapping Notion OK ; cartographie et principes repo v2.6 (`sfia-v2.6/2026-07-11-sfia-v2.6-repository-cartography.md`, `sfia-v2.6/2026-07-11-sfia-v2.6-repository-standard-principles.md`) |
...
| P1 | Mettre à jour `../archive/notion/notion-publication-plan.md` | `method/sfia-fast-track/documentation/` | Préparation Notion ; cartographie repo v2.6 en vigueur |
