...
| Frame Figma (référence) | Node ID | Écran P1 couvert | User stories | Incrément | Impact backlog | Statut |
|-------------------------|---------|------------------|--------------|-----------|----------------|--------|
| **01 — Dashboard cockpit premium** | `38:502` | Liste chantiers / dashboard | US-02 | INC-01 | Aucun | ✅ Aligné |
| **04 — Création chantier** | `38:3` | Création chantier | US-01 | INC-01 | Aucun | ✅ Aligné |
| **02 — Fiche chantier — Tâches** | `38:294` | Fiche pivot + section tâches | US-03, US-06, US-07 | INC-01, INC-02 | Aucun | ✅ Aligné |
| **03 — Fiche chantier — Réserves** | `38:105` | Fiche pivot + section réserves | US-03, US-08, US-09 | INC-01, INC-02 | Aucun | ✅ Aligné |

**Page Figma :** `38:2` — MVP P1 — Validé Morris. **Captures repo :** `04-design/captures/`.
...
**Documents liés :** `03-backlog/` (lecture seule), `figma-review-checklist.md`, `2026-07-06-design-decisions.md`
