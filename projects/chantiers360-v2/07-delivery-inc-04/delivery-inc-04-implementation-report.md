...
**Décision nommage :** champ `contenu` (backlog / data-model) plutôt que `content` — documenté dans `delivery-inc-04-decisions.md`.
...
**Documents liés :** `delivery-inc-04-validation-report.md`
