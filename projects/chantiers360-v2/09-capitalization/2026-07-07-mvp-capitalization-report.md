...
**Chemin :** `projects/chantiers360-v2/09-capitalization/2026-07-07-mvp-capitalization-report.md`  
**Date :** 2026-07-07  
**Branche :** `main` @ `bc3e097`  
**Type de cycle :** Capitalisation post-MVP — documentaire uniquement  
**Référence méthode :** `sfia-v2-incremental-delivery-closure-standard.md` — chaîne INC-n ; capitalisation INC-01 (`2026-07-06-inc-01-capitalization-report.md`, PR #111)
...
| F5 | **Besoin règles ADR / DAA / DAT** | Décisions techniques dispersées dans docs projet | Mergé PR #131 — `sfia-v2-technical-architecture-decision-documentation-standard.md` — standard SFIA v2.0 documenté — ADR/DAA/DAT projet non produits |
...
| # | Cycle | Statut |
|---|-------|--------|
| 1 | **Comparaison V0** | ✅ Mergée PR #136 — rapport `v0-vs-sfia-v2-methodological-comparison.md` — verdict : V2 NEEDS LIGHT CONSOLIDATION |
...
| 7 | **SFIA v2.4 consolidation** | Non lancée — recommandation comparaison V0 — décision Morris séparée |
...
2. **Ordre suggéré (non acté)** — au choix Morris :
   ...
   - ou ADR/DAA/DAT projet si objectif gouvernance technique Chantiers360 — **standard méthode mergé PR #131** (`sfia-v2-technical-architecture-decision-documentation-standard.md`).
...
| QA-G4 | `08-qa-test/inc-01/` à `inc-05/2026-07-07-qa-g4-post-merge-report.md` |
