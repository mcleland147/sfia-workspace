...
**Chemin :** `projects/chantiers360-v2/09-capitalization/2026-07-07-chantiers360-v2-pilot-metrics-capitalization-report.md`  
**Date :** 2026-07-07  
...
> Complète `2026-07-07-mvp-capitalization-report.md` et `v0-vs-sfia-v2-methodological-comparison.md` par une **lecture chiffrée** de la durée réelle et du volume de PR.
...
- `2026-07-06-inc-01-capitalization-report.md` — chaîne INC-n standardisée
