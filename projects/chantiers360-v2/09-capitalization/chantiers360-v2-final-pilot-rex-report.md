...
**Chemin :** `projects/chantiers360-v2/09-capitalization/chantiers360-v2-final-pilot-rex-report.md`  
**Date :** 2026-07-07  
...
- `mvp-capitalization-report.md` (PR #128)
- `v0-vs-sfia-v2-methodological-comparison.md` (PR #136)
- `chantiers360-v2-pilot-metrics-capitalization-report.md` (local)
- `inc-01-capitalization-report.md` (PR #111)
...
> **Correction capitalisée :** le rapport de comparaison V0 mentionnait « ~2 semaines » — **incorrect**. Voir `chantiers360-v2-pilot-metrics-capitalization-report.md` §2.
...
|----------|-----------|--------|
| `inc-01-capitalization-report.md` | Chaîne INC-n standardisée | Mergé PR #111 |
| `mvp-capitalization-report.md` | Cycle de vie MVP complet | Mergé PR #128 |
| `v0-vs-sfia-v2-methodological-comparison.md` | Comparaison méthodologique V0 | Mergé PR #136 |
| `chantiers360-v2-pilot-metrics-capitalization-report.md` | Métriques durée / PR / ratios | Local |
| `chantiers360-v2-final-pilot-rex-report.md` | REX stratégique final | Ce document |
...
| `chantiers360-v2-pilot-metrics-capitalization-report.md` | Métriques durée / PR |
| `inc-01-capitalization-report.md` | Standard chaîne INC-n |
