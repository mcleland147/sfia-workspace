...
**Chemin :** `projects/chantiers360-v2/07-delivery-inc-01/delivery-inc-01-implementation-report.md`
...
- Statuts INC-01 : **En retard** (livraison Morris) vs **En pause** (backlog US-04) — voir `delivery-inc-01-decisions.md`
