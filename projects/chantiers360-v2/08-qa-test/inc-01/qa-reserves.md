...
- **Mineures ouvertes :** R-QA-03 à R-QA-04 — **acceptées** pour INC-01 (GO QA WITH RESERVES)
...
| R-QA-03 à R-QA-04 | Mineures | **Ouvertes** — acceptées |
...
**GO QA WITH RESERVES** — acté Morris (QA-G3). PR #108 mergée. **QA-G4 OK WITH RESERVES** — clôture Morris accordée. **R-QA-02 levée** en micro-cycle post-capitalisation — R-QA-03 à R-QA-05 inchangées.
