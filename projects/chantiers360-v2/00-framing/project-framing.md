...
| **SFIA v2.x Method Versioning** | Mergée PR #133 — v2.3 actée — `sfia-v2-method-versioning-standard.md` — alignement v2.3.1 en cours |
...
16. **Alignement v2.3.1** — cycle courant — post-merge Method Versioning
