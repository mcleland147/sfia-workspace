...
| **Décision candidate** | `G-OPS1-TECH-ARCH` seulement sous GO Morris distinct. |
| **Impacts** | — |
| **Risques** | — |
| **Dette** | — |
| **Réserves** | — |
...
| **Recommandation** | (B) |
| **Décision candidate** | Aucun backlog OPS1 ouvert par ce pack. |
| **Impacts** | — |
| **Risques** | — |
| **Dette** | — |
| **Réserves** | — |
...
| **Recommandation** | (B) |
| **Décision candidate** | Statut global `functional-architecture-candidate` ; validation Morris ultérieure. |
| **Impacts** | Pas de push/PR auto |
| **Risques** | — |
| **Dette** | — |
| **Réserves** | Toutes réserves héritées maintenues |
| **Routé** | — |
| **Morris attendu** | Ouvrir `G-OPS1-FUNC-ARCH-VAL` quand prêt |
| **Statut** | `CANDIDATE — MORRIS VALIDATION REQUIRED` |

---

## 3. Décisions Morris requises

### Validation globale

- Valider ou amender l’architecture fonctionnelle OPS1 (docs 48–50) sous `G-OPS1-FUNC-ARCH-VAL`.

### Validables telles quelles (si Morris en convient)

- FA-CAND-01…10, 12, 14…17, 19…22 (sous réserve de lecture).

### Avec réserve explicite à maintenir

- FA-CAND-11, 13, 18 (liées FD-CAND-13/15/20/26).

### Nécessitant clarification éventuelle

- Noms exacts des composants (synonymes acceptables) ;
- granularité du catalogue d’événements (FA-CAND-08).

### Explicitement hors cycle

- Seuils FinOps numériques ;
- cartographie chemins Campus360 / convention branche ;
- stack / BDD / API / protocole ;
- Figma / backlog / delivery / live / MVP ;
- preuve live GPT/Cursor ;
- CI distante ; isolation OS/réseau ;
- suppression de branches ;
- push/PR de cette branche architecture.
...
22 décisions `OPS1-FA-CAND-01…22` — **aucune VALIDATED** dans ce cycle.
Réserves FD-CAND-13/15/20/26 et listes associées : **OPEN**.
