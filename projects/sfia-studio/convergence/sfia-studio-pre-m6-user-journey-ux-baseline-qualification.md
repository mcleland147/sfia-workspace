...
| Champ | Valeur |
|---|---|
| Statut | **BASELINE FONCTIONNELLE PRÉ-M6 ADOPTÉE + CONTRAT VISUEL D-PRE-M6-UX-05 ADOPTÉ COMME RÉFÉRENCE VISUELLE PRE-M6 — UI DELIVERY NON AUTORISÉE — PRE-M6 NON COMPLETE** |
| Rôle | Artefact de baseline fonctionnelle pré-M6 + readiness G-UX-01→15 + capitalisation de l’adoption visuelle D-PRE-M6-UX-05 |
| Cycle | Cycle 2 — Conception fonctionnelle · CONTINUATION / DÉCISION + GAP READINESS · **sync Cycle 15 capitalisation** (adoption visuelle) |
...
| Décision Morris consommée | Timeline : D-PRE-M6-UX-01/02/03 ADOPT ; **historique** D-PRE-M6-UX-04 = REQUALIFY → SELECT SLICE A → AMEND → FINAL AMEND ; **GO ACCEPT G-UX-15 SLICE A EXIT PROOF** (consommé) — technical blocker **CLOSED** ; **D-PRE-M6-UX-05 = ADOPTED AS PRE-M6 VISUAL REFERENCE** (Freeze `uUdLBElF2B4dOefaAYt4QY` · handoff `69106c…` / blob `3593dd…` · QA PASS WITH RESERVES / READY) |
...
- G-UX-15 : **SLICE A EXIT PROOF ACCEPTED BY MORRIS — TECHNICAL APPLICATION-WIRING BLOCKER CLOSED — FIXTURE-SAFE TECHNICAL PROOF ACCEPTED — PRODUCT/BROWSER E2E STILL PENDING** (architecture Slice A **ACCEPTED** ; **MERGED ON MAIN** via PR #354 ; UI Delivery / M6 toujours non autorisés).
...
- D-PRE-M6-UX-05 / Figma Visual Contract : **ADOPTED AS PRE-M6 VISUAL REFERENCE** (Freeze `uUdLBElF2B4dOefaAYt4QY` · handoff `69106c82024158889f77e9d31508a222ea5f3a0f` / blob `3593ddbdc286cd244790f0ca1d2c421128202c5c` · QA PASS WITH RESERVES / READY · réserves non bloquantes **ACCEPTED BY MORRIS**). **≠** UI Delivery authorized · **≠** Pre-M6 complete · **≠** runtime implemented.
- Pre-M6 UI Delivery : **NOT AUTHORIZED**.
- Pre-M6 global : **NON COMPLETE** (E2E PENDING · Confirmation KEEP RESERVE · Delivery not authorized).
...
## 15. Contrat d’entrée Figma — référence visuelle Pre-M6

**Historique :** avant D-PRE-M6-UX-05, statut = FIGMA INPUT DEFINED FOR DESIGN READINESS / FIGMA NOT AUTHORIZED / NO DECISION YET.

**Courant :** **D-PRE-M6-UX-05 = ADOPTED AS PRE-M6 VISUAL REFERENCE** — Freeze `uUdLBElF2B4dOefaAYt4QY` — evidence Review Handoff `69106c82024158889f77e9d31508a222ea5f3a0f` / blob `3593ddbdc286cd244790f0ca1d2c421128202c5c` — Visual QA **PASS WITH RESERVES / READY** — réserves non bloquantes **ACCEPTED BY MORRIS**. Voir §18 / §26.

Le tableau ci-dessous reste le contrat d’entrée **représenté** par le Freeze (scénarios / états). Adoption visuelle ≠ UI Delivery ≠ runtime.
...
Le Freeze Figma adopté représente la hiérarchie sémantique, l’autorité et la récupération comme **référence visuelle Pre-M6**. Il ne retire pas l’UI historique runtime et n’autorise pas la Delivery.

## 16. Futur contrat de preuve fonctionnelle

Après **ACCEPT** Morris de l’exit proof G-UX-15 Slice A (**déjà consommé**), puis après intégration main et autorisations séparées de Figma et UI Delivery, un E2E navigateur doit prouver substantiellement :
...
- périmètre M6, UI Delivery ou Cursor REAL (Figma Design Freeze déjà adopté comme référence visuelle — **≠** mutation Figma supplémentaire requise pour ce claim).
...
- **Ouvertes (current) :** qualification du prochain gate **Pre-M6 UI Delivery** (DISTINCT Morris GO — **NOT AUTHORIZED**) ; G-UX-08 / G-UX-10 hors Slice A ; Confirmation process-local = **KEEP RESERVE** ; product/browser E2E **PENDING**. **Complétés / historiques :** Cycle 13 PR-readiness · PR #354 merge · CI #192/#193 · Cycle 14 PR #355 merge · D-PRE-M6-UX-05 visual adoption.
...
### D-PRE-M6-UX-05 — Figma Visual Contract / référence visuelle Pre-M6

**Historique :** NO DECISION YET / FIGMA NOT AUTHORIZED (avant validation Morris).

**Statut courant : ADOPTED AS PRE-M6 VISUAL REFERENCE.**
...
ACCEPT DOCUMENTED NON-BLOCKING RESERVES —
NO UI DELIVERY YET — NO RUNTIME CHANGE — NO M6 — ZERO REAL
```

| Champ | Valeur |
|---|---|
| Figma Design Freeze | `uUdLBElF2B4dOefaAYt4QY` |
| Review evidence | commit `69106c82024158889f77e9d31508a222ea5f3a0f` · blob `3593ddbdc286cd244790f0ca1d2c421128202c5c` |
| Visual QA | **PASS WITH RESERVES / READY** |
| Decision | **MORRIS VALIDATED / ADOPTED AS PRE-M6 VISUAL REFERENCE** |
| Non-blocking reserves | **ACCEPTED BY MORRIS** (provenance manuelle · M-03 · M-04 · deferred visual polish) |

**Signification :** référence visuelle Pre-M6 adoptée. **≠** UI Delivery authorized · **≠** Pre-M6 complete · **≠** browser/product E2E proven · **≠** Confirmation restart-safe · **≠** M6 · **≠** runtime v3 ADOPTED · **≠** REAL.
...
**Courant :** sync documentaire de l’adoption visuelle (ce cycle) — candidat local docs — **aucun** commit/push/PR projet dans ce cycle.
...
**Acceptées non bloquantes (D-PRE-M6-UX-05 — ACCEPTED BY MORRIS) :**
1. **MANUAL EVIDENCE PROVENANCE RESERVE** — node-id exact / placement Figma page 02 non prouvé par MCP ; contenu visuel prouvé ; non bloquant pour l’adoption du contrat visuel.
2. **M-03** — chrome / LPS « Exécution en cours » visible sur variante Bloqué avant exécution ; objet pré-Attempt correct ; non bloquant.
3. **M-04** — pureté du pattern drawer F11B perfectible ; responsive contract represented ; non bloquant.
4. **DEFERRED VISUAL POLISH** — esthétique peut mûrir en Delivery ; aucune réouverture du contrat fonctionnel pour polish seul.

**Conservées (antérieures) :**
5. product/browser E2E = **PENDING**.
6. Confirmation process-local = **KEEP RESERVE**.
7. G-UX-08 — boucle AMEND incomplete ; requise pour parcours complet, pas pour premier happy-path GO-only.
8. G-UX-10 — actualité Recommendation à définir/câbler sans nouveau modèle de décision.
9. G-UX-09 — process-local accepté temporairement pour le premier test uniquement.
10. Dispositions individuelles de composants / RETIRE — non consommées (recommandations seulement).
11. M5-C owner / exit — dette de gouvernance distincte.

Accepted M-03/M-04/provenance ≠ reserves closed. Confirmation KEEP ≠ restart-safe Confirmation.
...
**Courant (ce cycle docs) :**
1. Git sync de l’adoption visuelle dans baseline + Roadmap — candidat local ;
2. ChatGPT review du Review Handoff — **next** (avant tout commit/push/PR docs).

**Ensuite (gates distincts — NON CONSOMMÉS) :**
3. Distinct Morris **COMMIT + PUSH + OPEN DRAFT PR** documentaire (si ChatGPT PASS) — **NOT AUTHORIZED** ici ;
4. **QUALIFY PRE-M6 UI DELIVERY GATE / SCOPE** — DISTINCT Morris GO — **UI Delivery NOT AUTHORIZED** ;
5. Puis seulement sous GOs séparés : UI Delivery → browser/product E2E → runtime visual evidence → Figma/runtime comparison → Morris UAT → gap/debt re-evaluation → M6 Entry Qualification.
...
- baseline fonctionnelle ADOPTÉE ≠ UX visuelle runtime implémentée
- **D-PRE-M6-UX-05 ADOPTED AS PRE-M6 VISUAL REFERENCE ≠ UI Delivery authorized ≠ runtime implemented ≠ browser/product E2E proven ≠ Figma/runtime aligned ≠ WCAG compliant ≠ Pre-M6 complete ≠ historical UI retired**
- gap readiness complète ≠ gap implementation complète
- G-UX-15 TECHNICAL BLOCKER CLOSED / MERGED ON MAIN ≠ PRODUCT E2E PROVEN ≠ UI DELIVERY AUTHORIZED ≠ PRE-M6 COMPLETE
- Accepted M-03/M-04/provenance reserves ≠ reserves closed
- Confirmation process-local KEEP ≠ restart-safe Confirmation
...
- runtime v3 remains **NON ADOPTED** · global v3 baseline **NOT PROMOTED**
...
**Historique (qualification readiness à la base `2f0d7236…`) :** sources ciblées `prepareM3FromDecision.ts`, `confirmAndExecuteF3Fixture.ts` / `ProjectAssistantPanel.tsx`, `recordDecision.ts`, `supersedeExecutionContract.ts`, `recommendNextGate.ts`, `rehydrateEvidenceOutcomeFromLps.ts` — à ce stade, aucune preuve ne permettait de rétrograder G-UX-15 hors BLOCKER technique.

**État gouverné courant :** G-UX-15 technical application-wiring blocker = **CLOSED BY MORRIS** (Slice A exit proof ACCEPTED) ; product/browser E2E proof = **PENDING** ; fixture-safe = preuve technique uniquement.
...
| Figma | MUST REPRESENT — **ADOPTED AS PRE-M6 VISUAL REFERENCE** (Freeze `uUdLBElF2B4dOefaAYt4QY`) |
| Delivery | Slice A technique **exit proof ACCEPTED** · **MERGED ON MAIN** (PR #354) ; UI Delivery **NOT AUTHORIZED** (Delivery gate distinct + product E2E pending) |
...
| Gate Morris | **ACCEPT G-UX-15 SLICE A EXIT PROOF — CONSUMED** · merge PR #354 **CONSUMED** · D-PRE-M6-UX-05 **ADOPTED** · prochain = qualify Pre-M6 UI Delivery gate |
| Owner | Owner missing |
...
Technical blocker CLOSED ≠ product/browser E2E proven. Fixture-safe proof accepted as **technical proof only**. ZERO REAL. Confirmation process-local = KEEP RESERVE. Local candidate ≠ on main. **D-PRE-M6-UX-05 ADOPTED AS PRE-M6 VISUAL REFERENCE ≠ UI Delivery authorized**. UI Delivery/M6 unauthorized. Aucun nouveau modèle de contrat / séquenceur.
...
**Morris ACCEPT CONSUMED.** Technical application-wiring blocker = **CLOSED**. Product/browser E2E proof remains **PENDING**. **D-PRE-M6-UX-05 = ADOPTED AS PRE-M6 VISUAL REFERENCE**. UI Delivery remains unauthorized until separate gate. Slice A **MERGED ON MAIN** (PR #354).
...
Prochaine décision Morris produit (après adoption visuelle) : **QUALIFY PRE-M6 UI DELIVERY GATE / SCOPE** (DISTINCT GO — **UI Delivery NOT AUTHORIZED**).
...
### FIGMA / VISUAL CONTRACT = **ADOPTED AS PRE-M6 VISUAL REFERENCE**

**Historique :** FIGMA READINESS = READY WITH FUNCTIONAL RESERVES · D-PRE-M6-UX-05 = NO DECISION YET / FIGMA NOT AUTHORIZED (avant adoption Morris).

**Courant :** Freeze `uUdLBElF2B4dOefaAYt4QY` · evidence `69106c…` / `3593dd…` · QA **PASS WITH RESERVES / READY** · décision **MORRIS VALIDATED / ADOPTED**.

**≠** UI Delivery authorized · **≠** runtime implemented · **≠** browser/product E2E proven · **≠** Figma/runtime aligned · **≠** WCAG compliant · **≠** Pre-M6 complete · **≠** historical UI retired.

Réserves visuelles acceptées non bloquantes : provenance manuelle · M-03 · M-04 · deferred polish — **ACCEPTED BY MORRIS** (≠ closed).

Réserves fonctionnelles conservées pendant Delivery future :

- G-UX-15 technical blocker CLOSED / product E2E pending (ne pas masquer) ; Confirmation process-local reserve ;
- G-UX-08/10 définis pour représentation Delivery ;
- G-UX-01–07/13 inputs de design ;
- G-UX-09 sémantique de reprise honnête ;
- G-UX-11/12/14 hors ou non-bloquants.

### UI DELIVERY READINESS = **NOT READY / NOT AUTHORIZED**

Parce que :

- Slice A est **MERGED ON MAIN** (PR #354) mais product/browser E2E **PENDING** ;
- le contrat visuel est **adopté** comme référence Pre-M6, mais **UI Delivery** reste un gate Morris distinct non consommé ;
- Confirmation process-local = **KEEP RESERVE** ;
- Pre-M6 **NON COMPLETE**.

Visual contract adopted ≠ Delivery readiness. Qualification du prochain gate Delivery = **NEXT** — **≠** Delivery GO.

Prérequis Delivery : GO Delivery séparé après qualification de gate/scope · puis preuves E2E / UAT.

### ROADMAP

Roadmap **MERGED ON MAIN** with Slice A via PR #354 ; Cycle 14 sync via PR #355 **MERGED** (`dd284e9…`). Ce cycle synchronise l’adoption visuelle D-PRE-M6-UX-05 (docs-only candidat local).
...
### CURRENT
11. Cycle 15 capitalisation — Git sync de l’adoption visuelle (baseline + Roadmap) — candidat local docs — **aucun** commit/push/PR projet ici.
12. ChatGPT review du Review Handoff — **next**.

### NEXT REPOSITORY GATE IF PASS
13. Distinct Morris **COMMIT + PUSH + OPEN DRAFT PR** documentaire — **NOT AUTHORIZED** ici.

### NEXT PRODUCT / CONVERGENCE GATE CANDIDATE
14. **QUALIFY PRE-M6 UI DELIVERY GATE / SCOPE** — DISTINCT Morris GO required — **UI Delivery = NOT AUTHORIZED**.
15. UI Delivery sur runtime existant — **NOT AUTHORIZED** (après qualification + GO distinct).
16. Browser E2E + preuves visuelles runtime.
17. Comparaison Figma/runtime.
18. Morris UAT (incl. Confirmation / process-local honesty).
19. Revue dettes/gaps restants (G-UX-08/10/12, M5-C owner, Confirmation reserve).
20. M6 Entry Qualification **uniquement** sous GO séparé — **NOT STARTED / NOT AUTHORIZED**.

G-UX-15 technical exit proof = **ACCEPTED**. Technical blocker = **CLOSED**. Fixture-safe = technical proof only. Slice A **MERGED ON MAIN**. D-PRE-M6-UX-05 **ADOPTED**. Product/browser E2E / UI Delivery / M6 remain later. Pre-M6 **NON COMPLETE**. runtime v3 **NON ADOPTED**. REAL = 0.
...
## 29. Compteurs de cycle (Cycle 15 — D-PRE-M6-UX-05 visual adoption Git sync)

Pre-M6 baseline modified = 1 · Roadmap modified = 1 · Resolver/export/tests modified = 0 · Build Doctrine/v3/method = 0 · UI/Figma mutation/Delivery/M6/REAL/Gate D = 0 · Confirmation = 0 · project commit/push/PR = 0 · branch delete = 0 · force push = 0 · Review Handoff push = 1 bounded L3
