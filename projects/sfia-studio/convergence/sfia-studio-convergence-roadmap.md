...
| **Statut** | trajectory **ACTIVE** · C1…C6 / UX / backlog / W1 / W2 **INTEGRATED** · **W2 CLOSED BY MORRIS** · **W3-A CLOSED BY MORRIS** · **W3-B CLOSED BY MORRIS** · **W3-C CLOSED BY MORRIS** · **W3 DELIVERY AUTHORIZED BY MORRIS / IN PROGRESS / NOT CLOSED** · next capability candidate **FULL CKC TRACK + CATALOG EVOLVABILITY** (US-P1-09 + US-P1-14) · **QUALIFIED NEXT W3 CAPABILITY CANDIDATE — NOT AUTHORIZED / NOT STARTED** · W3-D/E **NOT STARTED / NOT ASSIGNED** · FinOps/T7 **FREEZE** · Product Completion globale **INCOMPLETE / NON TERMINÉE** · REAL **OUT** · W4 **NOT STARTED** · runtime v3 **NON ADOPTED** |
...
| **Next cycle** | **FULL CKC TRACK + CATALOG EVOLVABILITY** (US-P1-09 + US-P1-14 · **QUALIFIED NEXT W3 CAPABILITY CANDIDATE — NOT AUTHORIZED / NOT STARTED** · Delivery slice **NOT YET ASSIGNED**) · W3 **NOT CLOSED** · **NO REAL WITHOUT DISTINCT MORRIS GO** · W3-D/E **NOT STARTED / NOT ASSIGNED** |
