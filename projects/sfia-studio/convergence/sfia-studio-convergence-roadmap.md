...
| **Morris trajectory decision (post-C6 / CKC)** | **ADOPTED BY MORRIS** — **STUDIO CKC FIRST BEFORE PRODUCT BACKLOG** (D-CKC15-14) · cadrage CKC Studio **VALIDATED BY MORRIS** · pin catalogue applicable validation-scope **PINNED** · Studio CKC corpus **15/15 CONTENT VALIDATED BY MORRIS** · Git integration candidate **IN PROGRESS / NOT YET ON MAIN** · Product Backlog **NOT OPENED** · ≠ Delivery · ≠ REAL · runtime v3 **NON ADOPTED** |
