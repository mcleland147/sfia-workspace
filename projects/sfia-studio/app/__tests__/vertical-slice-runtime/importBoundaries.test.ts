...
describe("V2-A1 vertical-slice-runtime import boundaries", () => {
  ...
  it("allows only the bounded V2 UI runtime entrypoints", () => {
    ...
    const allowed = new Set([
      ...
      "features/project-assistant/w2/evaluateProductRealReadiness.ts:@/lib/vertical-slice-runtime/managedRepoRootBaseConfig",
      ...
      "features/project-assistant/w2/materializeW3bProductTerminal.ts:@/lib/vertical-slice-runtime/managedRepoRootBaseConfig",
