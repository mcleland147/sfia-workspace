...
Projet de référence SFIA Fast Track.

## Arborescence active

| Dossier | Rôle |
|---------|------|
| `00-intake/` | Besoin initial, intake, stratégie de tests |
| `01-cadrage/` | Cadrage métier et arbitrages MVP |
| `02-architecture/` | Architecture active et ADR |
| `03-design/` | Design, design system, instructions Figma |
