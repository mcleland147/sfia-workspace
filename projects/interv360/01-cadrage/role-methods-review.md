...
La prochaine étape pourra consister à **extraire les premiers templates par rôle** dans `docs/practices/roles/`, en commençant par : business-analyst, product-owner, project-manager, ux-ui-designer, architect et rssi.
